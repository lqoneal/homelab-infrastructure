...
The canonical sequence is: Development WOP submission → autonomous implementation and correction → qualification → publication approval when required → publication → EOS synchronization → canonical Mission Contract activation → discovery → operational execution → qualification and closeout.
