# OA-21 Implementation Procedure

Implement only the work necessary to satisfy: Prove a qualifier independent of the execution agent evaluates implementation and evidence.
