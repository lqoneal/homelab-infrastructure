#!/usr/bin/env bash
# Gate identity: OA-28
# Capability statement: Mission Closeout
...
# Positive path: Through the authoritative CLI, prove completion reporting, final reconciliation, execution closure, and removal from active work.
# Negative path: Present a malformed, unauthorized, stale, mismatched, or incomplete OA-28 request and verify Zeus rejects it without advancing state.
# Idempotency: Repeat the OA-28 observation or authorized request with the same identity and verify no duplicate state, event, evidence, or action.
...
# Regression scope: OA-01, OA-02, OA-03, OA-04, OA-05, OA-06, OA-07, OA-08, OA-09, OA-10, OA-11, OA-12, OA-13, OA-14, OA-15, OA-16, OA-17, OA-18, OA-19, OA-20, OA-21, OA-22, OA-23, OA-24, OA-25, OA-26, OA-27
# Evidence requirements: repository identity and exact HEAD; command stdout, stderr, and return code; OA-28 positive and negative assertions; evidence integrity manifest and completion marker
...
exec "${SCRIPT_DIR}/../bin/pmct" run "OA-28" "$@"
