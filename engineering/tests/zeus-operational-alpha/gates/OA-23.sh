#!/usr/bin/env bash
# Gate identity: OA-23
# Capability statement: Safe Interruption
...
# Positive path: Through the authoritative CLI, prove durable pause behavior without inferred completion or duplicated effects.
