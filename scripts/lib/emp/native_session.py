...
ACTIVE_STATES = {"CREATED", "VERIFIED", "ACTIVE", "SUSPENDED", "RESUMED", "VERIFYING", "BLOCKED", "STOP_REQUESTED", "TERMINATING", "INTERRUPTED"}
...
TRANSITIONS = {
    ...
    "ACTIVE": {"SUSPENDED", "VERIFYING", "STOP_REQUESTED", "BLOCKED", "CANCELLED", "FAILED"},
    "STOP_REQUESTED": {"TERMINATING", "INTERRUPTED", "FAILED"},
    "TERMINATING": {"INTERRUPTED", "FAILED"},
