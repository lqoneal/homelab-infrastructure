...
class MissionRoadmapTests(unittest.TestCase):
    ...
    def test_current_mission_and_blocker_are_model_derived(self):
        ...
        self.assertEqual(current["mission_id"], "OA-28")
    ...
    def test_next_action_is_current_wop_projection(self):
        ...
        self.assertEqual(value["current_mission"], "OA-28")
        self.assertEqual(value["next_authorized_action"]["wop"], "WOP-OA-28-EXECUTION-001")
