...
class MissionRoadmapTests(unittest.TestCase):
    ...
    def test_current_mission_and_blocker_are_model_derived(self):
        ...
        self.assertEqual(current["mission_id"], "OA-26")
    ...
    def test_next_action_is_current_wop_projection(self):
        ...
        self.assertEqual(value["current_mission"], "OA-26")
        self.assertEqual(value["next_authorized_action"]["wop"], "WOP-OA-26-EXECUTION-001")
